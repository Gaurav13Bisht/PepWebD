...
// Use fresh Hackerrank ID(Fake/ Alternate) for this !!!!!
let id = "hawor48491@tlhao86.com";
let pass = "nottemp";
...
function solveQuestion(url) {
    ...
    return new Promise(function (resolve, reject) {
        tab.goto(editorialurl)
            //  Use these LOC if the ID is fresh i.e. Editorial section is locked of the topic.  
            // .then(function(){
            //     return new Promise(function(resolve,reject){
            //         setTimeout(() => {
            //             resolve();
